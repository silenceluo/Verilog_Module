...
#spyglass -project zeroskip_pipe_wrapper_MAC64.prj -batch -goal lint/lint_rtl -licqueue
spyglass -project zeroskip_pipe_wrapper_MAC256.prj -batch -goal lint/lint_rtl -licqueue
#spyglass -project zeroskip_pipe_wrapper_MAC1024.prj -batch -goal lint/lint_rtl -licqueue
