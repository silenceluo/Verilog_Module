...
create_clock -period 1200 -name design_clk [get_ports *clk*]
...
#set_input_delay 40 [all_inputs] -clock design_clk
#set_output_delay 40 [all_outputs] -clock design_clk

#set_clock_uncertainty  100 [get_clocks]
set_clock_uncertainty  100 [get_clocks]
#set_clock_uncertainty  20 [get_clocks]
...
#set_clock_uncertainty -setup 10 design_clk

#set_min_delay 300 -to [all_outputs]
set_min_delay 50 -to [all_outputs]
